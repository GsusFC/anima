  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (progress === 0) {
        ...
        setCurrentStep('Applying transitions...');
      } else if (progress < 80) {
        setCurrentStep('Encoding video...');
      } else if (progress < 95) {
        ...
        {(progress >= 100 || error) && (
          <button
            ...
            style={{
              width: '100%',
              padding: '12px',
              backgroundColor: progress >= 100 ? '#22c55e' : '#dc2626',
              border: 'none',
              borderRadius: '8px',
              color: 'white',
              fontSize: '12px',
          ...
          >
            {progress >= 100 ? '✅ EXPORT COMPLETE' : '❌ CLOSE'}
          </button>
        )}
      </div>
    </div>
